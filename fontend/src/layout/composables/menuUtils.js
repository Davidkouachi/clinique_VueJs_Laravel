...
export function filterMenuByRole(menu, role) {
    // console.log('▶️ Début filtrage menu pour rôle:', role);
    // console.log('Menu actuel:', menu.map(i => i.label || '(sans label)'));
    ...
    return menu
        .map(item => {
            ...
            // console.log('➡️ Item:', newItem.label || '(sans label)');
            // console.log('   🔐 Permissions:', newItem.permissions);
            // console.log('   👤 Rôle courant:', role);
            // console.log('   ✅ Autorisé ?', isAllowed);
            // console.log('   👶 Enfants visibles ?', hasChildren);
