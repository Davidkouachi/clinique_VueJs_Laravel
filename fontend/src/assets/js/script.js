...
Template Name: Preclinic - Bootstrap Admin Template toggle-password toggle_btn sidebar-close close-icon submenu
*/
...
(function () {
	...
	function init() {
		...
		if($('.trial-item').length > 0) {
			$(document).on("click", ".trial-item .close-icon", function () {
